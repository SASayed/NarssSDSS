                                    ...
                                    <ul class="icons-list">
                                        <li class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-right">
                                                <li><a href="${contextPath}/specialist/MCDA/editMCDA?name=<%=mcdas.get(i).getName()%>" onclick=""><i class="fa fa-pencil-square-o"></i> Edit</a></li>
                                                <li><a href="${contextPath}/specialist/MCDA/testMCDA?name=<%=mcdas.get(i).getName()%>"><i class="fa fa-play-circle"></i> Test</a></li>
                                                <li><a href="${contextPath}/specialist/MCDA/deleteMCDA?name=<%=mcdas.get(i).getName()%>"><i class="fa fa-times"></i> Delete</a></li>
                                            </ul>
                                        </li>
                                    </ul>
                                </td>
                ...
                <div class="col-md-8" style="width: 60%;">
                    ...
                    <div style="padding-top: 24px;">
                        <form action="" method="POST">
                            <legend>New MCDA</legend>
                            <div class="form-group col-md-12">
                                <label>Name</label>
                                <input type="text"  class="form-control" name="mcdaName" placeholder="The MCDA Name" required>
                                <i class="fa fa-info-circle" aria-hidden="true" data-toggle="tooltip" data-placement="top" title="The MCDA Name"></i>
                            </div>
                            <div class="form-group col-md-12">
                                <label for="exampleTextarea">Description</label>
                                <textarea class="form-control" name="mcdaDescription" rows="3"  placeholder="The MCDA Description" required></textarea>
